        ...
        <div>
            <form onSubmit={(e)=>{submitHandler(e)}}>
                ...
                <div>
                    <label>GENDER</label>
                    <br/>
                    MALE : <input type="radio" value="male" name='gender' onChange={(e)=>setgender(e.target.value)}></input> <br/>
                    FEMALE : <input type="radio" value="female" name='gender' onChange={(e)=>setgender(e.target.value)}></input> <br/>
                    {gender}
                </div>
                <div>
                    <label>SKILLS</label>
                    <br/>
                    HTML<input type="checkbox" value="HTML" name='skills' onChange={(e)=>{setskills([...skills,e.target.value])}}></input>
